workspace(name = "aspect_cli_pliugins")
...
# TODO: Should be switched out for a release
# Using a commit to make sure we have plugin compatibility with the test verb (which has not been released yet)
git_repository(
    name = "aspect_cli",
